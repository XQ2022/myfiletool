// FileTool.cpp : Defines the initialization routines for the DLL.
//
...
class CFileToolApp : public CWinApp
{
public:
	CFileToolApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CFileToolApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CFileToolApp)
...
BEGIN_MESSAGE_MAP(CFileToolApp, CWinApp)
	//{{AFX_MSG_MAP(CFileToolApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CFileToolApp object

CFileToolApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CFileToolApp construction

CFileToolApp::CFileToolApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CFileToolApp initialization

BOOL CFileToolApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CFileToolApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_FILETOOL_DESCRIPTION);
